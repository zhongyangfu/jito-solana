            ...
            loop {
                ...
                for slot in newly_computed_slot_stats {
                    ...
                    Self::mark_slots_confirmed(
                        &confirmed_slots,
                        &mostly_confirmed_slots.as_slice(),
                        &blockstore,
                        &bank_forks,
                        &mut progress,
                        &mut duplicate_slots_tracker,
...
pub(crate) mod tests {
    ...
    fn test_compute_bank_stats_confirmed() {
        ...
        assert_eq!(newly_computed, vec![1]);
        {
            ...
            let (confirmed_forks, mostly_confirmed_forks) = ReplayStage::confirm_forks(
                &tower,
                &fork_progress.fork_stats.voted_stakes,
                fork_progress.fork_stats.total_stake,
                &progress,
    ...
    fn test_mark_slots_confirmed() {
        ...
        let mut mostly_confirmed_slots = Vec::new();
        ReplayStage::mark_slots_confirmed(
            &confirmed_slots,
            &mut mostly_confirmed_slots,
            &blockstore,
            &bank_forks,
            &mut progress,
            &mut DuplicateSlotsTracker::default(),
